...
{
 "use strict";
 var Global,Samples,HelloWorld,EventEmitter,WebSharper,Operators,Seq,Arrays,State,Obj,UI,Doc,JavaScript,Pervasives,Enumerator,T,List,T$1,Elt,View,Client,Templates,Unchecked,JS,DomUtility,AttrProxy,Snap,EventTarget,Node,Collections,Dictionary,Updates,Array,DocElemNode,CharacterData,SC$1,HashSet,WindowOrWorkerGlobalScope,SC$2,Docs,Attrs,Object,Attrs$1,Dyn,DictionaryUtil,Prepare,Slice,KeyCollection,Abbrev,Fresh,SC$3,Strings,An,Settings,Mailbox,Docs$1,RunState,NodeSet,Anims,SC$4,HashSetUtil,SC$5,SC$6,Concurrency,AppendList,Easing,AsyncBody,SC$7,CT,HashSet$1,Queue,Scheduler,CancellationTokenSource,DomNodes,Error,OperationCanceledException,Lazy,SC$8,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime,console,$,Date;
 Global=self;
 ...
 State=HelloWorld.State=HelloWorld.State||{};
 ...
 {
  var gl,r,r$1,r$2,a;
  gl=new Global.GoldenLayout((r={},r.content=[(r$1=Object.assign({
   type:"row"
  },Global.$special,(r$2={},r$2.content=Arrays.ofSeq(Seq.map(HelloWorld.component_,Operators.range(1,3))),r$2)),r$1)],r),Global.jQuery("#gl-container"));
  gl.registerComponent("example",function($1,$2)
  {
   var x;
   x=Doc.Element("h2",[],[Doc.TextNode($2.Text)]).Html();
   $1.getElement().html(x);
  });
  gl.init();
  a=Doc.get_Empty();
  Templates.LoadLocalTemplates("");
  Doc.RunAppendById("main",a);
 };
 HelloWorld.component_=function(id)
 {
  var r,r$1,r$2;
  r=Object.assign({
   type:"component"
  ...
  },r$1.componentState=State.New("This is the content of Component "+Global.String(id)),r$1),(r$2={},r$2.title="My "+Global.String(id)+". component",r$2));
  return r;
 };
